    ...
    $('#form_block_validator').bootstrapValidator({
        fields: {
            ...
            nombre_test: {
                validators: {
                    notEmpty: {
                        message: 'Ingrese un nombre al test'
                    }
                }
            },
            descripcion_test: {
                validators: {
                    notEmpty: {
                        message: 'Ingrese una descripcion del test'
                    }
                }
            },
            curso_id: {
                validators: {
                    notEmpty: {
                        message: 'Seleccione el curso al que pertenece el test'
                    }
                }
            },
            contenido_id: {
                validators: {
                    notEmpty: {
                        message: 'Seleccione el contenido al que pertenece el test'
                    }
                }
            },
...
$("#form_inline_validator").on('error.form.bv', function(e) {
    console.log("jdl");
    $("#form_inline_validator .form-group").each(function(){
        $(this).find("small").appendTo($(this).find(".error_block"));
    });
});
