...
$(document).ready(function(){
    ...
    new Switchery(document.querySelector('.sm_disable'), { size: 'small', disabled: false });

    new Switchery(document.querySelector('.sm_disable_checked'), { size: 'small', disabled: false, color:'#0fb0c0',  jackColor: '#fff' });
    ...
    new Switchery(document.querySelector('.md_disable'), { disabled: false });
    new Switchery(document.querySelector('.md_disable_checked'), { color: '#668cff', jackColor: '#fff', disabled: false });
