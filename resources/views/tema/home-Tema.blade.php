            ...
            <div class="card">
                ...
                <div class="card-body m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="/tema/create-tema-hauser" id="editable_table_new" class=" btn btn-default">
                                Añadir Tema  <i class="fa fa-plus"></i>
                            </a>
                        </div>
                            ...
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="even">
                                        <td class="sorting_1">{{$temasHauser->nombre_tema}}</td>
                                        <td class="sorting_1">{{$temasHauser->descripcion_tema}}</td>
                                        <td class="sorting_1">
                                            @if($temasHauser->estado_tema)
                                            Activo
                                            @else
                                            Inactivo
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            &nbsp; &nbsp;
                                            <a class="edit" data-toggle="tooltip" data-placement="top" title="Editar" href="/tema/vista-editar-tema-hauser/{{$temasHauser->id}}"><i class="fa fa-pencil text-warning"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
