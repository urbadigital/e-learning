        ...
        <div class="inner bg-container">
            <div class="card">
                ...
                <div class="card-body m-t-35">
                    ...
                    <form method="POST" action="/tema/modificar-tema-hauser/{{$temaSeleccionado->id}}" class="form-horizontal login_validator" id="tryitForm" >
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group row m-t-25">
                                    <div class="col-lg-3 text-lg-right">
                                        <label for="tema" class="col-form-label">Nombre Tema*</label>
                                    </div>
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input-group-prepend">
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-file-o text-primary"></i>
                                    </span>
                                            <input type="text" class="form-control" required="" name="tema" value="{{$temaSeleccionado->nombre_tema}}" id="tema">
                                        </div>
                                        ...
                                        <div class="custom-controls-stacked">
                                            <label class="custom-control custom-radio">
                                                <input id="radio1" value="TRUE" type="radio" name="estado_tema"
                                                       class="custom-control-input" {{ ( $temaSeleccionado->estado_tema == TRUE ) ? 'checked' : '' }}>
                                                <span class="custom-control-label"></span>
                                                <span class="custom-control-description">Activo</span>
                                            </label>
                                            <label class="custom-control custom-radio">
                                                <input id="radio2" value="FALSE" type="radio" name="estado_tema"
                                                       class="custom-control-input"{{ ( $temaSeleccionado->estado_tema == FALSE ) ? 'checked' : '' }}>
                                                <span class="custom-control-label"></span>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3 text-lg-right">
                                        <label for="descripcion_tema" class="col-form-label">Descripcion*</label>
                                    </div>
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input-group-prepend">
                                            <span class="input-group-text  br-0 border-right-0 rounded-left"><i class="fa fa-pencil-square-o text-primary"></i></span>
                                            
                                            <textarea name="descripcion_tema" required="" class="form-control" id="descripcion_tema" cols="30" rows="10">{{$temaSeleccionado->descripcion_tema}}</textarea>
                                        </div>
                                    </div>
                                </div>
