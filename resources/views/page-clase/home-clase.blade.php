@extends(('layouts-clase/compact_menu'))
{{-- Page title --}}
@section('title')
    Widgets 1
    @parent
...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets-in/assets/css/pages/widgets.css')}}">
@stop
@section('content')
    <header class="head">
        <div class="main-bar">
                    ...
                    <div class="bg-white section_border">
                            ...
                            <div class="swiper-container men_shoes_swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{asset('assets-in/assets/img/shoesm1.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('assets-in/assets/img/shoesm2.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('assets-in/assets/img/shoesm3.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                </div>
                                <!-- Add Pagination -->
                        ...
                        <div class="header_align">
                            ...
                            <div class="swiper-container women_shoes_swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="{{asset('assets-in/assets/img/shoes.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('assets-in/assets/img/shoes2.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{asset('assets-in/assets/img/shoes3.png')}}" alt="Image missing" class="img-fluid"/>
                                    </div>
                                </div>
                                <div class="swiper-pagination"></div>
                            </div>
                ...
                <div class="col-lg-4 col-12 m-t-35">
                    <div class="card">
                        ...
                        <div class="card-body m-t-35">
                            <div class="row">
                                <div class="col-4">
                                    <img src="{{asset('assets-in/assets/img/images.jpg')}}" alt="admin" class="rounded-circle img-fluid">
                                </div>
                                ...
                                <div class="col-4">
                                    <img src="{{asset('assets-in/assets/img/authors/avatar7.jpg')}}" alt="admin" class="rounded-circle img-fluid avatar_rounded">
                                </div>
                            </div>
                            <div>
                                <div class="row m-t-5">
                    ...
                    <div class="bg-white section_border">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-12 m-t-5">
                                <form action="index" id="widgets_login_validator" method="get" class="login_validator header_align">
                                    <div class="form-group">
                                        <label for="email" class="col-form-label"> E-mail</label>
                                        <div class="input-group input-group-prepend">
                        <span class="input-group-text input_email"><i
                        ...
                        <span class="input-group-text addon_password"><i
                ...
                <div class="col-lg-3 col-sm-6 col-12 m-t-35">
                    <div class="card payment">
                        ...
                        <div class="bg-white">
                            ...
                            <div class="card-footer bg-white text-center">
                                <button class="btn btn-light btn-block get_plan_warning">GET PLAN</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12 col-12">
                                <div class="row">
                                    <div class="col-3 float-left">
                                        <img src="{{asset('assets-in/assets/img/authors/avatar1.jpg')}}" alt="Image missing" class="rounded-circle" height="50" width="50"/>
...
@section('footer_scripts')
    ...
    <script type="text/javascript" src="{{asset('assets-in/assets/js/pages/widget1.js')}}"></script>
@stop
