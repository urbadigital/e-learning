...
<head>
    ...
    <script src="{{ asset('js/activarPago.js') }}"></script>
     <!-- global styles-->
    <link type="text/css" rel="stylesheet" media="screen" href="{{asset('assets-in/assets/vendors/bootstrap3-wysihtml5-bower/css/bootstrap3-wysihtml5.min.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/vendors/summernote/css/summernote.css')}}"/>
...
<div id="wrap">
            ...
            <div class="menu_scroll">
                ...
                <ul id="menu">
                    ...
                    <ul>
                        ...
                        <a href="/tema/home-tema-hauser">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Temas 
                        </a>
                        </li>
                        <li {!! (Request::is('cards') ? 'class="active"' : '') !!}>
                        <a href="/curso/home-curso-hauser">
                            <i class="fa fa-angle-right"></i>
                            <span class="link-title">&nbsp;Cursos</span>
                        </a>
                        </li>
                        <li {!! (Request::is('transitions') ? 'class="active"' : '') !!}>
                        <a href="/contenido/home-contenido-curso-hauser">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Contenidos
                        </a>
                        </li>
                        <li {!! (Request::is('buttons') ? 'class="active"' : '') !!}>
                        <a href="/subcontenido/home-subcontenido-contenido-curso-hauser">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Subcontenidos
                        </a>
                        </li>
                        <li {!! (Request::is('icons') ? 'class="active"' : '') !!}>
                        <a href="/hauser/home-test">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Tests
                        </a>
                        </li>
                        <li {!! (Request::is('tooltips') ? 'class="active"' : '') !!}>
                        <a href="/hauser/home-test-preguntas">
                            <i class="fa fa-angle-right"></i>
                    ...
                    <ul>
                        ...
                        <a href="/hauser/home-instituciones">
                            <i class="fa fa-angle-right"></i>
                            &nbsp; Institutos
                        </a>
                        </li>
    ...
    <!-- /#content -->
    @include('layouts-admin/right_sidebar/default')
...
<script type="text/javascript" src="{{asset('assets-in/assets/vendors/tinymce/js/tinymce.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets-in/assets/vendors/bootstrap3-wysihtml5-bower/js/bootstrap3-wysihtml5.all.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets-in/assets/js/pluginjs/bootstrap3_wysihtml5.js')}}"></script>
<script type="text/javascript" src="{{asset('assets-in/assets/vendors/summernote/js/summernote.js')}}"></script>
    <!--End of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('assets-in/assets/js/pages/form_editors.js')}}"></script>
