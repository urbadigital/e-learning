        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid m-0">
                <a class="navbar-brand" href="index">
                    <h4><img src="{{asset('assets-in/assets/img/logo1.ico')}}" class="admin_img" alt="logo"> ADMIRE ADMIN</h4>
                </a>
                            ...
                            <div class="dropdown-menu drop_box_align" role="menu" id="messages_dropdown">
                                ...
                                <div id="messages">
                                    ...
                                    <div class="data">
                                        <div class="row">
                                            <div class="col-2">
                                                <img src="{{asset('assets-in/assets/img/mailbox_imgs/8.jpg')}}" class="message-img avatar rounded-circle"
                                                     alt="avatar1"></div>
                                    ...
                                    <div class="data">
                                        <div class="row">
                                            <div class="col-2">
                                                <img src="{{asset('assets-in/assets/img/mailbox_imgs/7.jpg')}}" class="message-img avatar rounded-circle"
                                                     alt="avatar1"></div>
                                    ...
                                    <div class="data">
                                        <div class="row">
                                            <div class="col-2">
                                                <img src="{{asset('assets-in/assets/img/mailbox_imgs/6.jpg')}}" class="message-img avatar rounded-circle"
                                                     alt="avatar1"></div>
                                            <div class="col-10 message-data">
                                                <strong>David</strong>
                            ...
                            <div class="dropdown-menu drop_box_align" role="menu" id="notifications_dropdown">
                                ...
                                <div id="notifications">
                                    <div class="data">
                                        <div class="row">
                                            <div class="col-2">
                                                <img src="{{asset('assets-in/assets/img/mailbox_imgs/1.jpg')}}" class="message-img avatar rounded-circle"
                                                     alt="avatar1"></div>
                                            <div class="col-10 message-data">
                                    ...
                                    <div class="data">
                                        <div class="row">
                                            <div class="col-2">
                                                <img src="{{asset('assets-in/assets/img/mailbox_imgs/3.jpg')}}" class="message-img avatar rounded-circle"
                                                     alt="avatar1"></div>
                                            <div class="col-10 message-data">
                                                <i class="fa fa-clock-o"></i>
                                                <strong>John</strong>
