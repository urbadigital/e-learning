        ...
        <div class="inner bg-container">
            <div class="card">
                <div class="card-header bg-white">
                    ...
                    Preguntas Inactivas del test: <b>{{$testHauser->nombre_test}}</b>
                </div>
                        ...
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Justificacion respuesta</th>
                                ...
                                <tbody>
                                    @if(sizeof($preguntasHauser)==0)
                                                         <tr>
                                                            <td class="text-center" colspan="7">No existen preguntas Inactivas</td>
                                                        </tr>
                                    @endif
