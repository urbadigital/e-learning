                                                ...
                                                <table class="table "  id="tabla"> 
                                                     <tr class="fila-fija">
                                                        <td>
                                                            ...
                                                            <input required="" title="El nombre del Video esta vacio" class="form-control required" id="nombre_video_pregunta" name="nombre_video_pregunta[]" placeholder="Nombre del video"/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
