                                    ...
                                    <div class="col-lg-6">
                                        <div class="custom-controls-stacked">
                                            <label class="custom-control custom-radio">
                                                <input id="radio1" value="1" type="radio"  name="tipo_pregunta" class="custom-control-input" {{ ( $preguntaSeleccionada->tipo_pregunta == 1 ) ? 'checked' : '' }}>
