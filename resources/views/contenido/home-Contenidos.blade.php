            ...
            <div class="card">
                ...
                <div class="card-body m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="/contenido/vista-create-contenido-curso-hauser" id="editable_table_new" class=" btn btn-default">
                                Añadir Contenido  <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    ...
                    <div>
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                ...
                                <tbody>
                                    @foreach($contenidosHauser as $contenidosHauser)
                                    <tr role="row" class="even">
                                        
                                        <td class="sorting_1">{{$contenidosHauser->nombre_contenido}}</td>
                                        <td class="sorting_1">{!!$contenidosHauser->descripcion_contenido!!}</td>
                                        
                                        <td class="sorting_1">
                                            @if($contenidosHauser->estado_contenido)
                                            Activo
                                            @else
                                            Inactivo
                                            @endif
                                        ...
                                        <td class="sorting_1">{{$contenidosHauser->nombre_curso}}</td>
                                        <td class="sorting_1">{{$contenidosHauser->nombre_tema}}</td>
                                        
                                        <td>
                                            <a href="view_user" data-toggle="tooltip" data-placement="top" title="Usuarios de Institucion"><i class="fa fa-eye text-success"></i></a>
                                            &nbsp; &nbsp;
                                            <a class="edit" data-toggle="tooltip" data-placement="top" title="Editar" href="/contenido/vista-editar-contenido-curso-hauser/{{$contenidosHauser->id}}"><i class="fa fa-pencil text-warning"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
