                                ...
                                <div class="card-body m-t-20">
                                    ...
                                    <div class="row"> 
                                        <div class="col">
                                            ...
                                            <form id="commentForm" method="POST" action="/contenido/create-contenido-hauser" class="validate" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div id="rootwizard">
                                                        ...
                                                        <div class="tab-pane" id="tab1">
                                                                ...
                                                                <label for="curso_id" class="control-label">Tema Curso *</label>
                                                                 <select class="form-control required" name="curso_id" id="curso_id">
                                                                            ...
                                                                            @foreach($cursoHauser as $cursoHauser)
                                                                                <option value="{{$cursoHauser->id}}">{{$cursoHauser->nombre_curso}}</option>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="descripcion_contenido" class="control-label">Descripcion Contenido
                                                                    *</label>
                                                                <textarea  class="form-control required" id="tinymce_full" rows="7" name="descripcion_contenido" cols="50" ></textarea>
                                                            </div>
                                ...
                                <div class="col-md-2 pull-rigth">
                                    ...
                                    <button id="adicional" name="adicional" type="button" class="btn btn-warning form-control">Añadir Nuevo Video</button>
                                                ...
                                                <table class="table "  id="tabla"> 
                                                     <tr class="fila-fija">
                                                        <td><input required="" title="El nombre del Video esta vacio" class="form-control required" id="nombre_video_contenido" name="nombre_video_contenido[]" placeholder="Nombre del video"/></td>
                                                        <td><input required="" class="form-control required" id="url_video_contenido" name="url_video_contenido[]" placeholder="URL"/></td>
                                                        <td>
                                                        <textarea required="" class="form-control required" maxlength="500"  id="descripcion_video_contenido" name="descripcion_video_contenido[]" placeholder="Descripcion del video" rows="6" onKeyDown="cuenta()" onKeyUp="cuenta()"></textarea>
                                                        </td>
                                                                    ...
                                                                    <div class="col-md-2">
                                                                                ...
                                                                                <button id="adicional1" name="adicional" type="button" class="btn btn-warning form-control">Añadir Nuevo Archivo</button>
                                                                                    ...
                                                                                    <table class="table "  id="tabla1">
                                                                                         <tr class="fila-fija">
                                                                                            <td><input required="" class="form-control required" type="file" value="Seleccione Archivo" name="nombre_archivo_contenido[]"></td>
                                                                                            <td>
                                                                                            <textarea required="" class="form-control required" required maxlength="500"  id="exampleTextarea" name="descripcion_archivo_contenido[]" placeholder="Descripcion del Archivo" rows="6" onKeyDown="cuenta()" onKeyUp="cuenta()"></textarea>
                                                                                            </td>
                                                                                            <td class="eliminar"><input type="button" class="btn btn-info form-control"  value="Borrar "/></td>
                                                                                        </tr>
                                                                                    </table>
