                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body m-t-35">
                            <form id="form_block_validator" method="POST" action="/hauser/modificar-test/{{$testSeleccionado->id}}" class="form-horizontal  login_validator"  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-file-o text-primary"></i>
                                            ...
                                            <input type="text" id="required2" name="nombre_test" class="form-control" required value="{{$testSeleccionado->nombre_test}}">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-file-o text-primary"></i>
                                            ...
                                            <select id="contenido_id" class="form-control required"  name="contenido_id" >
                                                <option value="" selected disabled>Escoja el curso del test</option>
                                                    @foreach($contenidosCursoHauser as $contenidosCursoHauser)
                                                        <option value="{{$contenidosCursoHauser->id}}" {{ ( $testSeleccionado->contenido_id == $contenidosCursoHauser->id ) ? 'selected' : '' }}>{{$contenidosCursoHauser->nombre_contenido}}</option>
                                                    @endforeach
                                        ...
                                        <div class="custom-controls-stacked">
                                            <label class="custom-control custom-radio">
                                                <input id="radio1" value="TRUE" type="radio" name="estado_test"
                                                       class="custom-control-input" {{ ( $testSeleccionado->estado_test == TRUE ) ? 'checked' : '' }}>
                                                <span class="custom-control-label"></span>
                                                <span class="custom-control-description">Activo</span>
                                            </label>
                                            <label class="custom-control custom-radio">
                                                <input id="radio2" value="FALSE" type="radio" name="estado_test"
                                                       class="custom-control-input" {{ ( $testSeleccionado->estado_test == FALSE ) ? 'checked' : '' }}>
                                                <span class="custom-control-label"></span>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group input-group-prepend">
                                            ...
                                            <textarea name="descripcion_test" required="" class="form-control" id="descripcion_test" cols="30" rows="10">{{$testSeleccionado->descripcion_test}}</textarea>
                                        </div>
                                    </div>
                                </div>
