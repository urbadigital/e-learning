        ...
        <div class="inner bg-container">
            <div class="card">
                ...
                <div class="card-body m-t-35">
                    <div>
                        <h4>Información Institucion</h4>
                    </div>
                    <form method="POST" action="/hauser/registrar-institucion" class="form-horizontal login_validator" id="tryitForm" >
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-building text-primary"></i>
                                            ...
                                            <input type="text" class="form-control" required="" name="nombre_institucion" id="nombre_institucion">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input-group-prepend">
                                            ...
                                            <textarea name="descripcion_institucion" required="" class="form-control" id="descripcion_institucion" cols="30" rows="10"></textarea>
                                        </div>
                                    </div>
                                </div>
