            ...
            <div class="card">
                ...
                <div class="card-body m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="/hauser/create-institucion" id="editable_table_new" class=" btn btn-default">
                                Añadir Institucion  <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    ...
                    <div>
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                <tr role="row">
                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Institucion</th>
                                    <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">Descripcion</th>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" class="even">
                                        <td class="sorting_1">{{$institucionesHauser->nombre_institucion}}</td>
                                        
                                        <td class="center">{{$institucionesHauser->descripcion_institucion}}</td>
                                        @if($institucionesHauser->estado_institucion==TRUE)
                                        <td>Activo</td>
                                        @else
                                        <td>Inactivo</td>
                                        @endif
                                        ...
                                        <td>
                                            <a href="/hauser/home-institucion-usuario/{{$institucionesHauser->id}}" data-toggle="tooltip" data-placement="top" title="Usuarios de Institucion"><i class="fa fa-eye text-success"></i></a>
                                            &nbsp; &nbsp;
                                            <a class="edit" data-toggle="tooltip" data-placement="top" title="Editar" href="/hauser/editar-instituciones/{{$institucionesHauser->id}}"><i class="fa fa-pencil text-warning"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
