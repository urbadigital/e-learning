        ...
        <div class="inner bg-container">
            <div class="card">
                ...
                <div class="card-body m-t-35">
                    ...
                    <form class="form-horizontal login_validator" id="tryitForm" action="/hauser/registrar-usuario-institucion"
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-building text-primary"></i>
                                            ...
                                            <select class="form-control" name="institucion_id" id="institucion">
                                                <option value="" disabled selected>Selecciones una Institucion</option>
                                                @foreach($institucionesHauser as $institucionesHauser)
                                                <option value="{{$institucionesHauser->id}}">{{$institucionesHauser->nombre_institucion}}</option>
                                                @endforeach
                                            </select>
                                        </div>
