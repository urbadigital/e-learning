        ...
        <div class="inner bg-container">
            <div class="card">
                ...
                <div class="card-body m-t-35">
                    ...
                    <form class="form-horizontal login_validator" id="tryitForm" action="/hauser/actualizar-usuario-institucion/{{$usuarioSeleccionado->id}}"
                            ...
                            <div class="col-12">
                                    ...
                                    <div class="col-lg-6 text-center text-lg-left">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new  text-center">
                                                <img width="170"  height="170" src="/storage/User/{{$usuarioSeleccionado->avatar}}"  id="myImage"  alt="not found">
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-building text-primary"></i>
                                            ...
                                            <select class="form-control" name="institucion_id" id="institucion">
                                                <option value="" disabled >Selecciones una Institucion</option>
                                                @foreach($institucionesHauser as $institucionesHauser)
                                                <option value="{{$institucionesHauser->id}}" {{ ( $usuarioSeleccionado->institucion_id == $institucionesHauser->id ) ? 'selected' : '' }}>{{$institucionesHauser->nombre_institucion}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-user text-primary"></i>
                                            ...
                                            <input required type="text" value="{{$usuarioSeleccionado->name}}" name="name" id="u-name"
                                                   class="form-control">
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-user text-primary"></i>
                                            ...
                                            <input required type="text" value="{{$usuarioSeleccionado->lastname}}" name="lastname" id="u-name"
                                                   class="form-control">
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-blind text-primary"></i>
                                            ...
                                            <input required type="text" name="username" value="{{$usuarioSeleccionado->username}}" id="u-name"
                                                   class="form-control">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input-group-prepend">
                                            ...
                                            <input required type="text" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" placeholder=" " title="mail@example.com" value="{{$usuarioSeleccionado->email}}" id="email" name="email"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input-group-prepend">
                                            ...
                                            <input type="text" placeholder=" " value="{{$usuarioSeleccionado->numero}}" id="phone" name="numero"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
