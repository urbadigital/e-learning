            ...
            <div class="card">
                ...
                <div class="card-body m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="/hauser/create-usuario-institucion" id="editable_table_new" class=" btn btn-default">
                    ...
                    <div>
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                ...
                                <tbody>
                                    @foreach($UsuariosHauser as $UsuariosHauser)
                                    <tr role="row" class="even">
                                        <td class="sorting_1">{{$UsuariosHauser->name}}</td>
                                        <td class="sorting_1">{{$UsuariosHauser->lastname}}</td>
                                        <td class="sorting_1">{{$UsuariosHauser->username}}</td>

                                        
                                        <td class="center">{{$UsuariosHauser->nombre_institucion}}</td>
                                        <td class="center">{{$UsuariosHauser->email}}</td>
                                       
                                        
                                        <td>
                                            <a href="view_user" data-toggle="tooltip" data-placement="top" title="Usuarios de Institucion"><i class="fa fa-eye text-success"></i></a>
                                            &nbsp; &nbsp;
                                            <a class="edit" data-toggle="tooltip" data-placement="top" title="Editar" href="/hauser/editar-usuario-institucion/{{$UsuariosHauser->id}}"><i class="fa fa-pencil text-warning"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
