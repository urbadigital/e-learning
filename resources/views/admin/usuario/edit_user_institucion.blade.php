        ...
        <div class="inner bg-container">
            <div class="card">
                ...
                <div class="card-body m-t-35">
                    ...
                    <form class="form-horizontal login_validator" id="tryitForm" action="/hauser/actualizar-institucion-usuario/{{$usuarioInstitucionSeleccionado->id}}"
                            ...
                            <div class="col-12">
                                    ...
                                    <div class="col-lg-6 text-center text-lg-left">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new  text-center">
                                                <img width="170"  height="170" src="/storage/User/{{$usuarioInstitucionSeleccionado->avatar}}"  id="myImage"  alt="not found">
                                ...
                                <div class="form-group row m-t-25 " hidden>
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-building text-primary"></i>
                                            ...
                                            <input type="text" name="institucion_id" value="{{$usuarioInstitucionSeleccionado->institucion_id}}">
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-user text-primary"></i>
                                            ...
                                            <input required type="text" value="{{$usuarioInstitucionSeleccionado->name}}" name="name" id="u-name"
                                                   class="form-control">
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-user text-primary"></i>
                                            ...
                                            <input required type="text" value="{{$usuarioInstitucionSeleccionado->lastname}}" name="lastname" id="u-name"
                                                   class="form-control">
                                        </div>
                                ...
                                <div class="form-group row m-t-25">
                                    ...
                                    <span class="input-group-text br-0 border-right-0 rounded-left"> <i class="fa fa-blind text-primary"></i>
                                            ...
                                            <input required type="text" name="username" value="{{$usuarioInstitucionSeleccionado->username}}" id="u-name"
                                                   class="form-control">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input-group-prepend">
                                            ...
                                            <input required type="text" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" placeholder=" " title="mail@example.com" value="{{$usuarioInstitucionSeleccionado->email}}" id="email" name="email"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-xl-6 col-lg-8">
                                        <div class="input-group input-group-prepend">
                                            ...
                                            <input type="text" placeholder=" " value="{{$usuarioInstitucionSeleccionado->numero}}" id="phone" name="numero"
                                                   class="form-control">
                                        </div>
                                    </div>
                                </div>
