            ...
            <div class="card">
                ...
                <div class="card-body m-t-35" id="user_body">
                    <div class="table-toolbar">
                        <div class="btn-group">
                            <a href="/subcontenido/vista-create-subcontenido-contenido-curso-hauser" id="editable_table_new" class=" btn btn-default">
                                Añadir Subcontenido  <i class="fa fa-plus"></i>
                            </a>
                        </div>
                    ...
                    <div>
                        <div>
                            <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                <thead>
                                <tr role="row">
                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Subontenido</th>
                                    <th class="sorting_asc wid-10" tabindex="0" rowspan="1" colspan="1">Descripcion</th>
                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Estado</th>
                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Contenido</th>
                                    <th class="sorting_asc wid-20" tabindex="0" rowspan="1" colspan="1">Curso</th>
                                ...
                                <tbody>
                                    @foreach($SubcontenidosHauser as $SubcontenidosHauser)
                                    <tr role="row" class="even">
                                        
                                        <td class="sorting_1">{{$SubcontenidosHauser->nombre_subcontenido}}</td>
                                        <td class="sorting_1">{!!$SubcontenidosHauser->descripcion_subcontenido!!}</td>
                                        
                                        <td class="sorting_1">
                                            @if($SubcontenidosHauser->estado_subcontenido)
                                            Activo
                                            @else
                                            Inactivo
                                            @endif
                                        </td>
                                        <td class="sorting_1">{{$SubcontenidosHauser->nombre_contenido}}</td>
                                        <td class="sorting_1">{{$SubcontenidosHauser->nombre_curso}}</td>
                                        <td class="sorting_1">{{$SubcontenidosHauser->nombre_tema}}</td>
                                        
                                        <td>
                                            <a href="view_user" data-toggle="tooltip" data-placement="top" title="Usuarios de Institucion"><i class="fa fa-eye text-success"></i></a>
                                            &nbsp; &nbsp;
                                            <a class="edit" data-toggle="tooltip" data-placement="top" title="Editar" href="/subcontenido/vista-editar-subcontenido-contenido-curso-hauser/{{$SubcontenidosHauser->id}}"><i class="fa fa-pencil text-warning"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
