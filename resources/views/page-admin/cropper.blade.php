...
@section('header_styles')
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/vendors/cropper/css/cropper.min.css')}}"/>
    <!-- end of page level styles -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets-in/assets/css/pages/cropper.css')}}">
    <!-- end of page level styles -->
@stop
...
@section('content')
    ...
    <div class="outer">
        <div class="inner bg-container">
            <div class="row">
                <div class="col">
                    <img id="image" src="{{asset('assets-in/assets/img/crop.jpg')}}" alt="not found">
...
@section('footer_scripts')
    <!-- page scripts-->
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/cropper/js/cropper.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets-in/assets/js/pages/cropper.js')}}"></script>
    <!--End page scripts-->
@stop