                ...
                <div class="col-sm-8">
                    <ol  class="breadcrumb float-right nav_breadcrumb_top_align notifications_text_hover">
                        <li class="breadcrumb-item">
                            <a href="index1" >
                                <i class="fa fa-home" data-pack="default"></i>
                                Dashboard
                            </a>
                        </li>
                        <li class="breadcrumb-item">
                                    ...
                                    <div class="checkbox-list">
                                        <div>
                                            <label class="custom-control custom-checkbox" for="closeButton">
                                                ...
                                                <span class="custom-control-label checker" id="uniform-closeButton"> </span>
                                            </label></div><div>
                                            <label class="custom-control custom-checkbox" for="addBehaviorOnToastClick">
                                                ...
                                                <span class="custom-control-label checker" id="uniform-addBehaviorOnToastClick"></span>
                                            </label></div><div>
                                            <label class="custom-control custom-checkbox" for="debugInfo">
                                                ...
                                                <span class="custom-control-label checker" id="uniform-debugInfo"> </span>
                                            </label></div>
                                    </div>
                                </div>
                            </div>
