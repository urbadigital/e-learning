                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="Browser_stats_ul">
                                <li><span><img alt="google" src="{{asset('assets/img/chrome.png')}}"/>Google Crome</span><span
                                            class="float-right text-mint">32%<i
                                                class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="firebox" src="{{asset('assets/img/firefox.png')}}">Firefox</span><span
                                            class="float-right text-danger">5%<i
                                                class="fa fa-level-down"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="safari" src="{{asset('assets/img/safari2.png')}}">Safari</span><span
                                            class="float-right text-mint">10%<i
                                                class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="opera" src="{{asset('assets/img/opera.png')}}">Opera</span><span
                                            class="float-right text-mint">32%<i
                                                class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="ie" src="{{asset('assets/img/Ie.png')}}">IE</span><span
                                            class="float-right text-danger">15%<i
                                                class="fa fa-level-down"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="mobile" src="{{asset('assets/img/mobile1.png')}}">Mobile</span><span
                                            class="float-right text-mint">32%<i
                                                class="fa fa-level-up"></i></span>
                                    <hr/>
                                </li>
                                <li><span><img alt="others" src="{{asset('assets/img/others.png')}}">Others</span><span
                                            class="float-right text-mint">32%<i
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('assets/img/images.jpg')}}" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
...
Lorem Ipsum is simply dummy text of the printing.</span>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('assets/img/images3.jpg')}}" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
                                        <div class="col-10 col-lg-9 col-xl-10">
...
Lorem Ipsum is simply dummy text of the printing.</span>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('assets/img/images2.jpg')}}" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
                                        <div class="col-10 col-lg-9 col-xl-10">
...
Lorem Ipsum is simply dummy text of the printing.</span>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-2 col-lg-3 col-xl-2">
                                            <img src="{{asset('assets/img/images4.jpg')}}" class="rounded-circle"
                                                 alt="image not found">
                                        </div>
                                        <div class="col-10 col-lg-9 col-xl-10">
