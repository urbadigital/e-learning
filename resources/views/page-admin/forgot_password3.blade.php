        ...
        <div class="col-10 mx-auto push-1 login_section">
            <div class="row">
                <div class="col-lg-4 col-sm-8 mx-auto login2_border forgot_section_top">
                    ...
                    <div class="m-t-15">
                        <form action="login3" id="login_validator1" method="get" class="form-group  login_validator bv-form" novalidate="novalidate">
                            <div class="login_content login_border_radius">
                                ...
                                <div class="form-group text-center">
                                    <button type="submit" onclick="window.location.href='login3'" class="btn btn-success submit_email b_r_20 login_button m-t-10">Submit
                                    </button>
                                </div>
                            </div>
                        </form>
