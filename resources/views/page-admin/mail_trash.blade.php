                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item bg-success">
                                <a href="mail_trash" class="mail_inbox_text_col">
                                    <span class="badge badge-warning badge-pill tag tag-warning tag-pill float-right">16</span>
                                    <i class="fa fa-trash"></i>
                                    Trash
                                </a>
                            </li>
                            ...
                            <li class="list-group-item starred_mail">
                                <a href="#">
                                    <span class="badge badge-primary badge-pill  tag tag-primary tag-pill float-right">3</span>
                        ...
                        <div class="card-header bg-white">
                            <div class="row">
                                <div class="col-sm-6 col-12 m-t-10 dropdown_list_hover">
                                    ...
                                    <div class="btn-group float-left table-bordered text-primary" id="refresh_trash">
