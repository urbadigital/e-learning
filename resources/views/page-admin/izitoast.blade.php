...
@section('header_styles')
    <!--Plugin styles -->
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/vendors/izitoast/css/iziToast.min.css')}}" />
            ...
            <div class="row no-gutters">
                ...
                <div class="col-sm-8">
                    <ol  class="breadcrumb float-right nav_breadcrumb_top_align notifications_text_hover">
                        ...
                        <li class="active breadcrumb-item">Izi-Toast</li>
                    </ol>
                </div>
            </div>
        </div>
...
@section('footer_scripts')
    <!-- Plugin scripts -->
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/izitoast/js/iziToast.min.js')}}"></script>
    <!--End of plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('assets-in/assets/js/pages/izi_toastr.js')}}"></script>
