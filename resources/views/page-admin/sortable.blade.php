...
@section('header_styles')
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/css/pages/sortable.css')}}" />
                                ...
                                <div id="multi" class="row">
                                    <div class="col-lg-4 m-t-25">
                                        <div class="layer tile" data-force="30">
                                            ...
                                            <div class="tile__list">
                                                <img src="{{asset('assets-in/assets/img/authors/avatar.jpg')}}" alt="image" />
                                                <img src="{{asset('assets-in/assets/img/roundicons/flat/Food-19.png')}}" alt="image"/>
                                                <img src="{{asset('assets-in/assets/img/roundicons/flat/Technology-10.png')}}" alt="image"/>
                                                <img src="{{asset('assets-in/assets/img/gallery/full/1.jpg')}}" alt="image"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 m-t-25">
                                    ...
                                    <div class="col-lg-4 m-t-25">
                                        <div class="layer tile" data-force="20">
                                            ...
                                            <div class="tile__list">
                                                <img src="{{asset('assets-in/assets/img/authors/avatar7.jpg')}}" alt="image"/>
                                                <img src="{{asset('assets-in/assets/img/authors/avatar.jpg')}}" alt="image"/>
                                            </div>
                                        </div>
                                    </div>
...
@section('footer_scripts')
    <!--Plugin scripts-->
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/sortable/js/Sortable.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/slimscroll/js/jquery.slimscroll.min.js')}}"></script>
    <!--End of Plugin scripts-->
    <!--Page level scripts-->
    <script type="text/javascript" src="{{asset('assets-in/assets/js/pages/sortable.js')}}"></script>
