    ...
    <div class="outer">
        <div class="inner bg-container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 col-md-6 col-12 m-t-35">
                    <div class="bg-white section_border text-center">
                        <div class="p-t-25">
                ...
                <div class="col-12 col-lg-5 col-md-12 col-12 m-t-35">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="bg-white section_border m-t-35">
                                <div class="row">
                                ...
                                <div class="bg-white px-2">
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <button class="btn btn-secondary btn-sm mt-2"><i class="fa fa-thumbs-up"></i>
                                                Like
                                            </button>
                                            <button class="btn btn-danger btn-sm mt-2"><i class="fa fa-heart"></i> Love
                                            </button>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-3 m-t-35">
                    <div class="user-name1 text-center section_border">
                        <div class="bg-mint">
                            <div class="text-center">
                            ...
                            <span class="fa-stack fa-lg widget_plus_icon">
                                    <i class="fa fa-circle f    a-stack-2x text-white"></i>
