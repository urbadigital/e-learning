                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg input_field_sections">
                                    <h5>Disabled</h5>
                                    <form>
                                        <input type="text" class="form-control disabled_input" name="disabled"
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control">
                                        <span class="input-group-text  border-left-0 rounded-right">.00</span>
                                    </div>
                                    <div class="input-group input_top_align">
                                        <span class="input-group-text border-right-0 br-0 rounded-left">$</span>
                                        <input type="text" class="form-control">
                                        <span class="input-group-text border-left-0 rounded-right">.00</span>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-lg m-t-35 form_input_fields">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text border-left-0 rounded-right">(999) 999-9999</span>
                                        </div>
                                    </div>
                                    <div class="col-lg m-t-35 form_input_fields">
                                        <h5>Product key</h5>
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text border-left-0 rounded-right">a*-999-a999</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col-lg form_input_fields m-t-35">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text border-left-0 rounded-right">09/01/1992</span>
                                        </div>
                                    </div>
                                    <div class="col-lg form_input_fields m-t-35">
                                        <h5>Percent</h5>
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-text border-left-0 rounded-right">99%</span>
                                        </div>
                                    </div>
