...
@section('header_styles')
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets-in/assets/vendors/Buttons/css/buttons.min.css')}}"/>
    <!--End of global styles-->
    <!--Page level styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/css/pages/buttons.css')}}"/>
...
@section('footer_scripts')
    ...
    <!-- plugin scripts -->
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/raphael/js/raphael.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/Buttons/js/scrollto.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/Buttons/js/buttons.js')}}"></script>
