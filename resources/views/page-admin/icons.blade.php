...
@section('header_styles')
    <!-- global styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets-in/assets/vendors/themify/css/themify-icons.css')}}" />
    <!-- Plugin styles-->
    <link rel="stylesheet" type="text/css" href="{{asset('assets-in/assets/vendors/ionicons/css/ionicons.min.css')}}" />
    <!-- end of plugin styles -->
    <link rel="stylesheet" type="text/css" href="{{asset('assets-in/assets/css/pages/icon.css')}}" />
@stop
@section('content')
    <header class="head">
        <div class="main-bar">
                                                    ...
                                                    <form>
                                                        <div class="input-group">
                                                            ...
                                                            <div class="form-group input-group">
                                                                <span class="input-group-text border-right-0 br-0 addon_button_background"><i class="fa fa-search"></i></span>
                                                ...
                                                <div class="col-md-4 m-t-20">
                                                    <form>
                                                        <div class="input-group">
                                                            <label for="icon-search" class="sr-only">Search</label>
                                                            <div class="form-group input-group">
                                                                <span class="input-group-text br-0 addon_button_background"><i class="fa fa-search"></i></span>
...
@section('footer_scripts')
    <script type="text/javascript" src="{{asset('assets-in/assets/js/pages/icons.js')}}"></script>
