        ...
        <div class="col-12">
            <div class="row">
                <div class="col-lg-4 col-sm-8 col-md-6 mx-auto forgotpwd_margin ">
                    ...
                    <form action="login1" id="login_validator1" method="get"
                        ...
                        <div class="bg-white login_content login_border_radius">
                            ...
                            <div class="form-group form-actions">
                                <button type="submit" class="btn btn-primary submit_email login_button" onclick="window.location.href='login1'">Submit
                                </button>
                            </div>
                        </div>
                    </form>
