...
@section('header_styles')
    <!--plugin style-->
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/vendors/animate/css/animate.min.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/vendors/hover/css/hover-min.css')}}"/>
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/vendors/wow/css/animate.css')}}"/>
    <!-- end of plugin styles-->
    <link type="text/css" rel="stylesheet" href="{{asset('assets-in/assets/css/pages/animations.css')}}"/>
@stop
...
@section('footer_scripts')
    <!--gend of global script-->
    <!--plugin script-->
    <script type="text/javascript" src="{{asset('assets-in/assets/vendors/snabbt/js/snabbt.min.js')}}"></script>
