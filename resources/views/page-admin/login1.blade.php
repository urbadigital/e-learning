            ...
            <div class="row">
                <div class="col-lg-5  col-md-8  col-sm-12 mx-auto">
                    ...
                    <div class="bg-white login_content login_border_radius">
                        <form action="{{url('index')}}" id="login_validator" method="get" class="login_validator">
                            {{csrf_field()}}
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-6 text-right forgot_pwd">
                                    <a href="forgot_password1" class="custom-control-description forgottxt_clr">Forgot password?</a>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
