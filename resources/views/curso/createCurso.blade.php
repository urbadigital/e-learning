                        ...
                        <div class="col">
                            <div class="card m-t-35">
                                ...
                                <div class="card-body m-t-20">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <form id="commentForm" method="POST" action="/curso/create-curso" class="validate" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                                <div id="rootwizard">
                                                    ...
                                                    <div class="tab-content m-t-20">
                                                        <div class="tab-pane" id="tab1">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="anexo" class="control-label">Imagen Curso *</label>
                                                                
                                                                       <div class="col-lg-2 col-12 m-t-3">
                                            
                                                                            <div class="m-t-15">
                                                                                <input class="form-control required" accept="image/png, .jpeg, .jpg, image/gif" id="anexo" name="anexo" type="file" data-max-file-size="3M"/>
                                                                            </div>
                                                                        </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md 6">
                                                                  <div class="form-group">
                                                                        <label for="email" class="control-label">Fecha Inicio
                                                                            *</label>
                                                                         <input type="date" name="tiempo_inicio_curso" id="tiempo_inicio_curso" value="{{ date('Y-m-d') }}" class="form-control required" />
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                         ...
                                                                         <label for="email" class="control-label">Fecha Final
                                                                            *</label>
                                                                         <input type="date" name="tiempo_fin_curso" id="tiempo_fin_curso" value="{{ date('Y-m-d') }}" class="form-control required" />
                                                                ...
                                                                <label for="tema_id" class="control-label">Tema Curso *</label>
                                                                 <select class="form-control required" name="tema_id" id="tema_id">
                                                                            ...
                                                                            @foreach($temasHauser as $temasHauser)
                                                                                <option value="{{$temasHauser->id}}">{{$temasHauser->nombre_tema}}</option>
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <label class="custom-control custom-checkbox wizard_label_block">
                                                                            <input type="radio" id="chechboxCurso"
                                                                                  name="tipo_curso" onclick="ocultar()" value="1"
                                                                        ...
                                                                        <label class="custom-control custom-checkbox wizard_label_block">
                                                                            <input type="radio" id="chechboxCurso"
                                                                                  id="chechboxCurso" name="tipo_curso" onclick="mostrar()" value="2"
                                                                                   class="form-control-input">
                                                                            <span class="custom-control-indicator"></span>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group" id="pago" style="display:none">
                                                                        ...
                                                                        <input   id="costoCurso" class="form-control" name="costo" type="number"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="descripcion_cortas_curso" class="control-label">Descripcion Corta
                                                                    *</label>
                                                                <textarea  class="form-control required summernote_editor" id="descripcion_cortas_curso" rows="7" name="descripcion_cortas_curso" cols="50" ></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="descripcion_curso" class="control-label">Descripcion Detallada
                                                                    *</label>
                                                                <textarea  class="form-control required" id="tinymce_full" rows="7" name="descripcion_curso" cols="50" ></textarea>
                                                            </div>
                                ...
                                <div class="col-md-2 pull-rigth">
                                    <label for=""><strong>Videos del Curso</strong></label> <br>
                                    <button id="adicional" name="adicional" type="button" class="btn btn-warning form-control">Añadir Nuevo Video</button>
                                </div>
                                                
                                                <table class="table "  id="tabla">
                                                     <tr class="fila-fija">
                                                        <td><input required="" title="El nombre del Video esta vacio" class="form-control required" id="nombre_video_curso" name="nombre_video_curso[]" placeholder="Nombre del video"/></td>
                                                        <td><input required="" class="form-control required" id="url_video_curso" name="url_video_curso[]" placeholder="URL"/></td>
                                                        <td>
                                                        <textarea required="" class="form-control required" maxlength="500"  id="exampleTextarea" name="descripcion_video_curso[]" placeholder="Descripcion del video" rows="6" onKeyDown="cuenta()" onKeyUp="cuenta()"></textarea>
                                                        </td>
                                                                    ...
                                                                    <div class="col-md-2">
                                                                                ...
                                                                                <button id="adicional1" name="adicional" type="button" class="btn btn-warning form-control">Añadir Nuevo Archivo</button>
                                                                                    ...
                                                                                    <table class="table "  id="tabla1">
                                                                                         <tr class="fila-fija">
                                                                                            <td><input required="" class="form-control" type="file" value="Seleccione Archivo" name="nombre_archivo_curso[]"></td>
                                                                                            <td>
                                                                                            <textarea required="" class="form-control" required maxlength="500"  id="exampleTextarea" name="descripcion_archivo_curso[]" placeholder="Descripcion del Archivo" rows="6" onKeyDown="cuenta()" onKeyUp="cuenta()"></textarea>
                                                                                            </td>
                                                                                            <td class="eliminar"><input type="button" class="btn btn-info form-control"  value="Borrar "/></td>
                                                                                        </tr>
                                                                                    </table>
