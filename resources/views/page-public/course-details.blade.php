        ...
        <div class="container com-sp pad-bot-70">
            ...
            <div class="row">
                <div class="ed-course">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="admission.html">
                                <img src="images/course/imagen-curso-2.jpg" alt="">
                                <span>Admission</span>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="dashboard.html">
                                <img src="images/course/imagen-curso-3.jpg" alt="">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href=".html">
                                <img src="images/course/imagen-curso-4.jpg" alt="">
